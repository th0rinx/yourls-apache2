...
define( 'YOURLS_DB_USER', 'administrador' );
...
define( 'YOURLS_SITE', 'https://links.ejercito.mil.ar' );
...
define( 'YOURLS_COOKIEKEY', 'Eqp[Kj3RrC0wZOXvS7K99Vd$8t$hZv8d1nBxL~LY' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = [
	'sistemas' => 'phpass:!2a!08!9DLSGXGhzcyoSZCrrSOAQOoV7IVXflaQ22Xtib2ET2W7ZHKCL5xoe' /* Password encrypted by YOURLS */ ,
